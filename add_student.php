		...
		if ($link) {
			...
			if ($row_cnt == 0) {
				$query1 = mysqli_query(
					...
					(s_name,gender,e_id,dob,address,phone,s_cred,s_sem,s_dep) 
					VALUES('" . $name . "','" . $gender . "','" . $eid . "','" . $dob . "','" . $address . "','" . $phone . "','" . $s_cred . "','" . $s_sem . "','" . $sdept . "')"
				);
				//echo $row_cnt;
				//$query1 = mysqli_query($link,"insert into stud_info (s_name,gender,e_id,dob,address,phone,s_cred) values('".$name."','".$gender."','".$eid."','".$dob."','".$address."','".$phone."','0')");
